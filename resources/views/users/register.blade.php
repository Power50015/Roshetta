    ...
    <section class="form-page">
        <div class="form-page-content">
            <div class="min-h-[100vh]  flex items-center justify-center">
                <form action="{{ url('register') }}" method="POST" class="flex flex-col py-5 border rounded">
                    ...
                    <div class="p-4 flex items-center justify-center">
                        ...
                        <input dir="ltr" type="text" name="email" id="email" class="w-full rounded">
                    </div>
                    <div class="p-4 flex items-center justify-center">
                        <label for="phone" class="w-2/6 text-sky-100">رقم الهاتف</label>
                        <input type="tel" maxlength="12" id="phone" name="phone" class="w-full rounded" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                    </div>
                    <div class="p-4 flex items-center justify-center">
                    ...
                    <div class="p-4 flex items-center justify-center">
                        <label for="password_confirmation" class="w-2/6 text-sky-100">كلمه المرور</label>
                        <input type="password" name="password_confirmation" id="password_confirmation" class="w-full rounded" >
                    </div>
