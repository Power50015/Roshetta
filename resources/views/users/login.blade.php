    ...
    <section class="form-page">
        <div class="form-page-content">
            <div class="min-h-[100vh]  flex items-center justify-center">
                <form action="{{ url('login') }}" method="POST" class="flex flex-col py-5 border rounded">
                    ...
                    <div class="p-4 flex items-center justify-center">
                        ...
                        <input type="text" name="email" id="email" class="w-full rounded" value="powermostafa50015@outlook.com">
                    </div>
                    <div class="p-4 flex items-center justify-center">
                        <label for="password" class="w-2/6 text-sky-100">كلمه المرور</label>
                        <input type="password" name="password" id="password" class="w-full rounded" value="powermostafa50015@outlook.com">
                    </div>
