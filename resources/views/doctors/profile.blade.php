        ...
        <div class="border my-8">
            ...
            <div class="flex flex-col md:flex-row justify-around">
                <div class="p-5 border-b md:border-b-0 md:border-l ">
                    ...
                    <form action="{{route('doctor-profile-img.update')}}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                    ...
                    <form action="{{route('doctor-profile-img.delete')}}" method="POST">
                        @method('DELETE')
                        @csrf
                ...
                <div class="p-5">
                    <form action="{{route('doctor-profile-information.update')}}" method="POST">
                        @method('PUT')
                        @csrf
